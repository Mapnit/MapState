...
function (declare, esriRequest, all, lang, array, html, json, _WidgetsInTemplateMixin, BaseWidget, portalUtils,
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
        ...
        constructor: function (options) {
            ...
            this.gpServiceUrlPortal = options.config.gpServiceUrlPortal;
        ...
        _populateGroupShareTo: function () {
            if (!this._isGroupsPopulated) {
                ...
                this._geoprocessorPortal.execute(paramsPortal, lang.hitch(this, function (results) {
                    if (results && results.length > 0) {
                        array.forEach(results, lang.hitch(this, function (result) {
                            if (result.paramName === 'Group') {
                                array.forEach(result.value, lang.hitch(this, function (item) {
                                    dijit.byId('groupChkMultiSelect').addOption({ 'label': item, 'value': item });
                                }));
                                this._accessibleGroups = result.value;
                            }
        ...
        _initGPService: function () {
            ...
            this._geoprocessorPortal = new Geoprocessor(this.gpServiceUrlPortal);
        },
        ...
        _createThumbnail: function () {
            ...
            this._printTask.execute(this._printTaskParams, lang.hitch(this, function (result) {
                ...
                this._createMapstate(this._getConfigName(), newUrl);
                    ...
                    if (dynamicData[key].url != undefined) {
                        ...
                        if (layerObjects.indexOf(dynamicData[key].url) == -1) {
                            ...
                            if (dynamicData[key].type == 'ArcGISDynamicMapServiceLayer') {
                                ...
                                var tiledLayer = new TiledMapServiceLayer(dynamicData[key].url, {
                                    'visible': dynamicData[key].visible,
                                    'opacity': dynamicData[key].opacity
                                });
                            ...
                            else if (dynamicData[key].type == 'ArcGISFeatureLayer') {
        ...
        _clearResults: function () {
            ...
            if (this._geoprocessorPortal)
                this._geoprocessorPortal = null;
